Sosol::Application.routes.draw do
  ...
  match 'build' => 'docos#build', :as => :build, :via => :get
  match 'documentation' => 'docos#documentation', :as => :documentation, :via => :get
  ...
  match 'publications/:publication_id/:controller/:id/show_commit/:commit_id' => 'identifiers#show_commit', :commit_id => /[0-9a-fA-F]{40}/, :via => :get
